...
* **Alertas de Stock Crítico:** Desarrollar un sistema automatizado de notificaciones visuales para advertir cuando un producto esté próximo a agotarse (basado en stock mínimo parametrizable).
* **Persistencia Local Eficiente:** Integrar una base de datos ligera de alto rendimiento que garantice la consistencia de la información de extremo a extremo sin dependencias complejas de red.
* **Arquitectura de Software Profesional:** Aplicar las mejores prácticas de desarrollo e ingeniería de software, estructurando el código fuente de manera limpia, modular, escalable y mantenible.
